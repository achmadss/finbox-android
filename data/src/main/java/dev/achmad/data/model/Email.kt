...
/**
 * One fetched email: what it takes to find it again and what has been tried on
 * it. Duplicate messages in a known thread are skipped before fetching. The body
 * is not kept — a parser installed later re-reads it from Gmail.
 *
