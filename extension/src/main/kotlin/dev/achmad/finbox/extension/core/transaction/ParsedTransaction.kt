package dev.achmad.finbox.extension.core.transaction
...
data class ParsedTransaction(
    ...
    /** ISO 4217, e.g. `IDR`. */
    val currency: String,
    /** Unix epoch millis. Pass [dev.achmad.finbox.extension.core.source.email.model.Email.date] when the receipt states no time. */
    val date: Long,
