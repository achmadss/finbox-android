...
import dev.achmad.finbox.util.preference.AndroidPreference.BooleanPrimitive
import dev.achmad.finbox.util.preference.AndroidPreference.FloatPrimitive
import dev.achmad.finbox.util.preference.AndroidPreference.IntPrimitive
import dev.achmad.finbox.util.preference.AndroidPreference.LongPrimitive
import dev.achmad.finbox.util.preference.AndroidPreference.ObjectAsString
import dev.achmad.finbox.util.preference.AndroidPreference.StringPrimitive
import dev.achmad.finbox.util.preference.AndroidPreference.StringSetPrimitive
