...
data class ExtensionDetailsScreen(private val pkg: String) : Screen {
    ...
    override fun Content() {
        ...
        val model = rememberScreenModel(tag = pkg) { ExtensionDetailsScreenModel(pkg) }
...
private fun DetailsHeader(
    ...
    Column(
        ...
        Text(
            text = extension.pkg, // TODO remove the base package like dev.achmad.finbox (only for UI purposes)
            ...
            Button(
                ...
                Text(
                    when {
                        ...
                        else -> "Update to v${extension.update.versionName}"
                    },
                )
            }
        }
