package dev.achmad.finbox.source.core.util
...
class ReceiptTest {
    ...
    @Test
    fun `an html body is flattened, not read as it arrived`() {
        val email = Email(
            ...
            date = 0L,
            body = "<table><tr><td>Amount</td><td>Rp 2.000</td></tr></table>",
        )
